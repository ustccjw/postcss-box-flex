...
describe('box-flex', () => {
  test('box-flex: 0', async () => {
    ...
    expect(res.css).toBe('div { display: -webkit-box }; span { -webkit-box-flex: 0; } div > * { display: block }')
  })

  test('box-flex: 1', async () => {
    const input = 'div { display: -webkit-box }; span { -webkit-box-flex: 1; }'
    const res = await postcss([plugin()]).process(input)
    expect(res.css).toBe('div { display: -webkit-box }; span { width: 1px; -webkit-box-flex: 1; } div > * { display: block }')
  })
})
